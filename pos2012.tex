...
Preliminary results presented at the conference determined uncertainties from the full spread of optimal \al predicted by the different observables; here, instead, we average over the observables to determine the optimal \al and associated uncertainties. % Is ``average over'' clear enough?
