...
We use a blocking factor of two to match lattice volumes $24^3x48$, $12^3x24$, and $6^3x12$.
...
We determine the optimal $\alpha_{optimal}$ by requiring that the value of $\Delta\beta$ for the $24^3x48\to3^3x6$ matching and the $12^3x24\to3^3x6$ matching are identical.
