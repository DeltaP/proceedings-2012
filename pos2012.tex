...
\abstract{
  ...
  Our results for 8 flavors show confinement while our results for 12 flavors are indicative of an infrared fixed point (IRFP).
  The difficulty of obtaining a single beta function due to the optimization of our block transformation is discussed.
