...
\abstract{ % Draft complete
  ...
  While both procedures produce qualitatively similar bare step-scaling functions, the new $s_b$ obtained using the Wilson flow have the distinct advantage of corresponding to unique discrete \be functions.
}
...
While our 8-flavor results for $s_b$ are significantly different from zero for all couplings we can explore, for $N_f = 12$ we find $s_b < 0$ for $\be_F < 8$. %\footnote{Preliminary results presented at the conference }
